        ...
        <div class="col-md-10">
            <div class="panel panel-primary panel-transparent">
                 <div class="panel-body">
                         <!--body context-->
                     <div>
                         <p>We apologise but this webpage is not avaiable on mobile. If you would like to go home click <a href="index.html">here.</a> If you would like to visit the raid groups please click <a href="raid.html">here.</a></p>
                     </div>
                     <!--body end-->
                </div>
           </div>
