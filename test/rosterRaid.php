        ...
        <div class="col-md-10">
            <div class="panel panel-primary panel-transparent">
                 <div class="panel-body">
                         <!--body context-->
  <h2>Raid Team 1</h2>
  <p>Click apply to send a request to join any of the raid groups. Please make the subject relvant to the group and slot.</p>            
  <table class="table">
    <thead>
      <tr>
        <th width="24px">Job</th>
        <th width="50px"></th>
    ...
    <tbody>
      <tr>
        <td><img src="assets/tank.png"></td>
        <td>PLD/WAR/DRK</td>
        <td>&#40;Free Slot&#41;</td>
        <td><a href="apply.php"><button class="btn btn-default">Apply</button></a></td>
      </tr>
      <tr>
        <td><img src="assets/tank.png"></td>
        <td>PLD/WAR/DRK</td>
      ...
      <tr>
        <td><img src="assets/healer.png"></td>
        <td>WHM/SCH/AST</td>
        <td>&#40;Free Slot&#41;</td>
        <td><a href="apply.php"><button class="btn btn-default">Apply</button></a></td>
      </tr>
