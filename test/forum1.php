        ...
        <div class="col-md-10">
            <div class="panel panel-primary panel-transparent">
                 <div class="panel-body">
                         <!--body context-->
                     <p>Welcome to your home away from home! Feel free to use our forum to communicate ideas, guides, or just a general chat with each other. This is a place you you to talk to other members outside of FC chat. To start posting simply request access and you should be able to start posting within 24 hours!</p>
                     <h6 style="color:white">If you cannot see the Google Groups page below, please try CTRL-F5. Failing that, you may need to be signed into a google account to access the forum.</h6></div></div>
            <div style="margin-bottom:100px;" class="panel panel-primary">
                <div class="panel-body">
