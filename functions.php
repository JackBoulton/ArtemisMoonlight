...
print "<div class='pager'> 
        <img src='".curPageURL()."css/first.png' class='first'/> 
        <img src='".curPageURL()."css/prev.png' class='prev'/> 
        <span class='pagedisplay'></span>
        <img src='".curPageURL()."css/next.png' class='next'/> 
        <img src='".curPageURL()."css/last.png' class='last'/> 
